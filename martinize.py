...
class martini21:
    ...
    def __init__(self):
        ...
        self.sidechains = {
            ...
            "TRP": [spl("SC4 SP1 SC4 SC4"), [(0.300, 5000)] + [(0.270, None) for i in range(5)],
                    [(210, 50), (90, 50), (90, 50)], [(0, 50), (0, 200)]],
            "TYR": [spl("SC4 SC4 SP1"), [(0.320, 5000), (0.270, None), (0.270, None), (0.270, None)],
                    [(150, 50), (150, 50)], [(0, 50)]],
            "PHE": [spl("SC4 SC4 SC4"), [(0.310, 7500), (0.270, None), (0.270, None), (0.270, None)],
                    [(150, 50), (150, 50)], [(0, 50)]],
            "HIS": [spl("SC4 SP1 SP1"), [(0.320, 7500), (0.270, None), (0.270, None), (0.270, None)],
                    [(150, 50), (150, 50)], [(0, 50)]],
            "HIH": [spl("SC4 SP1 SQd"), [(0.320, 7500), (0.270, None), (0.270, None), (0.270, None)],
                    [(150, 50), (150, 50)], [(0, 50)]],
        ...
        self.connectivity = {
            ...
            "TRP": [[(0, 1), (1, 2), (1, 3), (2, 3), (2, 4), (3, 4)], [(0, 1, 2), (0, 1, 3)],
                    [(0, 2, 3, 1), (1, 2, 4, 3)]],
...
class martini22:
    ...
    def __init__(self):
        ...
        self.sidechains = {
            # RES#   BEADS                   BONDS                                                   ANGLES              DIHEDRALS
            #                               BB-SC          SC-SC                                        BB-SC-SC  SC-SC-SC
            "TRP": [spl("SC4 SNd SC5 SC5"), [(0.300, 5000)] + [(0.270, None) for i in range(5)],
                    [(210, 50), (90, 50), (90, 50)], [(0, 50), (0, 200)]],
            "TYR": [spl("SC4 SC4 SP1"), [(0.320, 5000), (0.270, None), (0.270, None), (0.270, None)],
                    [(150, 50), (150, 50)], [(0, 50)]],
            "PHE": [spl("SC5 SC5 SC5"), [(0.310, 7500), (0.270, None), (0.270, None), (0.270, None)],
                    [(150, 50), (150, 50)], [(0, 50)]],
            "HIS": [spl("SC4 SP1 SP1"), [(0.320, 7500), (0.270, None), (0.270, None), (0.270, None)],
                    [(150, 50), (150, 50)], [(0, 50)]],
            "HIH": [spl("SC4 SP1 SQd"), [(0.320, 7500), (0.270, None), (0.270, None), (0.270, None)],
...
class martini22p:
    ...
    def __init__(self):
        ...
        self.sidechains = {
            ...
            "HIS": [spl("SC4 SP1 SP1"), [(0.320, 7500), (0.270, None), (0.270, None), (0.270, None)],
                    [(150, 50), (150, 50)], [(0, 50)]],
            "HIH": [spl("SC4 SP1 SQd D"), [(0.320, 7500), (0.270, None), (0.270, None), (0.270, None), (0.11, None)],
                    [(150, 50), (150, 50)], [(0, 50)]],
...
class elnedyn:
    ...
    def __init__(self):
        ...
        self.sidechains = {
            # RES#   BEADS                      BONDS                                                                    ANGLES                          DIHEDRALS
            'TRP': [spl("SC4 SP1 SC4 SC4"),
                    [(0.255, 73000), (0.220, None), (0.250, None), (0.280, None), (0.255, None), (0.35454, None)],
                    [(142, 30), (143, 20), (104, 50)], [(180, 200)]],
            'TYR': [spl("SC4 SC4 SP1"), [(0.335, 6000), (0.335, 6000), (0.240, None), (0.310, None), (0.310, None)],
                    [(70, 100), (130, 50)]],
            'PHE': [spl("SC4 SC4 SC4"), [(0.340, 7500), (0.340, 7500), (0.240, None), (0.240, None), (0.240, None)],
                    [(70, 100), (125, 100)]],
            'HIS': [spl("SC4 SP1 SP1"), [(0.195, None), (0.193, None), (0.295, None), (0.216, None)],
                    [(135, 100), (115, 50)]],
        ...
        self.connectivity = {
            # RES       BONDS                                     ANGLES                            DIHEDRALS       V-SITE
            "TRP": [[(0, 1), (1, 2), (2, 4), (4, 3), (3, 1), (1, 4)], [(0, 1, 2), (0, 1, 4), (0, 1, 3)],
                    [(1, 2, 3, 4)]],
    ...
    def bbGetAngle(self, r, ca, ss):
        ...
        return (
        math.acos(cos_angle([i - j for i, j in zip(ca[0], ca[1])], [i - j for i, j in zip(ca[2], ca[1])])) / d2r, 40)
...
class elnedyn22:
    ...
    def __init__(self):
        ...
        self.sidechains = {
            # RES#   BEADS                      BONDS                                                                    ANGLES                          DIHEDRALS
            'TRP': [spl("SC4 SNd SC5 SC5"),
                    [(0.255, 73000), (0.220, None), (0.250, None), (0.280, None), (0.255, None), (0.35454, None)],
                    [(142, 30), (143, 20), (104, 50)], [(180, 200)]],
            'TYR': [spl("SC4 SC4 SP1"), [(0.335, 6000), (0.335, 6000), (0.240, None), (0.310, None), (0.310, None)],
                    [(70, 100), (130, 50)]],
            'PHE': [spl("SC5 SC5 SC5"), [(0.340, 7500), (0.340, 7500), (0.240, None), (0.240, None), (0.240, None)],
                    [(70, 100), (125, 100)]],
            'HIS': [spl("SC4 SP1 SP1"), [(0.195, None), (0.193, None), (0.295, None), (0.216, None)],
                    [(135, 100), (115, 50)]],
            'HIH': [spl("SC4 SP1 SP1"), [(0.195, None), (0.193, None), (0.295, None), (0.216, None)],
                    [(135, 100), (115, 50)]],
            'ARG': [spl("N0 Qd"), [(0.250, 12500), (0.350, 6200)], [(150, 15)]],
            'LYS': [spl("C3 Qd"), [(0.250, 12500), (0.300, 9700)], [(150, 20)]],
            'CYS': [spl("C5"), [(0.240, None)]],
...
class elnedyn22p:
    ...
    def __init__(self):
        ...
        self.sidechains = {
            ...
            'HIS': [spl("SC4 SP1 SP1"), [(0.195, None), (0.193, None), (0.295, None), (0.216, None)],
                    [(135, 100), (115, 50)]],
            'HIH': [spl("SC4 SP1 SQd"), [(0.195, 94000), (0.193, None), (0.295, None), (0.216, None), (0.11, None)],
                    [(135, 100), (115, 50)]],
...
forcefields = [str(ff).split('.')[-1] for ff in globals().values() if
               (type(ff) == types.ClassType and hasattr(ff, "ff"))]
        ...
        try:
            ...
            try:
                ...
                cmd_subfolder = os.path.realpath(
                    os.path.dirname(inspect.getfile(inspect.currentframe()))) + "/ForceFields"
...
AA3 = spl(
    "TRP TYR PHE HIS HIH ARG LYS CYS ASP GLU ILE LEU MET ASN PRO HYP GLN SER THR VAL ALA GLY" + dnares3 + rnares3)  # @#
AA1 = spl(
    "  W   Y   F   H   H   R   K   C   D   E   I   L   M   N   P   O   Q   S   T   V   A   G" + dnares1 + rnares1)  # @#
...
class CoarseGrained:
    ...
    mapping = {
        ...
        "DA": nsplit("P OP1 OP2 O5' O3' O1P O2P", "C5' O4' C4'", "C3' C2' C1'", "N9 C4", "C8 N7 C5", "C6 N6 N1",
                     "C2 N3"),
        "DG": nsplit("P OP1 OP2 O5' O3' O1P O2P", "C5' O4' C4'", "C3' C2' C1'", "N9 C4", "C8 N7 C5", "C6 O6 N1",
                     "C2 N2 N3"),
...
def call_dssp(chain, atomlist, executable='dsspcmbi'):
    ...
    try:
        if os.system(executable + " -V 2>/dev/null"):
            ...
            p = subp.Popen([executable, "-i", "/dev/stdin", "-o", ssdfile], stderr=subp.PIPE, stdout=subp.PIPE,
                           stdin=subp.PIPE)
        else:
        ...
        for j in chainIndex[i + 1:]:
            ...
            for cysA in chains[i]["CYS"]:
                for cysB in chains[j]["CYS"]:
                    ...
                    if d2 <= ss_cutoff:
                        logging.info(
                            "Found SS contact linking chains %d and %d (%f nm)" % (i + 1, j + 1, math.sqrt(d2) / 10))
                        pairs.append((i, j))
                    break
                if (i, j) in pairs:
                    break
...
class Topology:
    ...
    def __str__(self):
        if self.multiscale:
            out = ['; MARTINI (%s) Multiscale virtual sites topology section for "%s"' % (
            self.options['ForceField'].name, self.name)]
        else:
    ...
    def fromAminoAcidSequence(self, sequence, secstruc=None, links=None,
        ...
        for i, j in zip([0] + breaks, breaks + [-1]):
            ...
            self.angles.extend(
                [Angle(triple, options=self.options, category="BBB") for triple in zip(frg, frg[1:], frg[2:])])
        ...
        for resi, resname, bbb, sidechn, ss in zip(resid, self.sequence, bb, sc, self.secstruc):
            ...
            if bbb in self.options['ForceField'].charges.keys() and resname in self.options[
                'ForceField'].mass_charge.keys():
    ...
    def fromNucleicAcidSequence(self, sequence, secstruc=None, links=None, breaks=None,
        ...
        for resi, resname, bbb, sidechn, ss in zip(resid3, sequence3, bb3, sc3, secstruc3):
            ...
            if (count % 3) == 0:
                ...
                bon_con, ang_con, dih_con, imp_con, vsite_con = (
                                                                self.options['ForceField'].connectivity[resname] + 5 * [
                                                                    []])[:5]
...
def main(options):
    ...
    for title, atoms, box in frameIterator(inStream):
        ...
        for chain in chains:
            logging.info(
                "  %2d:   %s (%s), %d atoms in %d residues." % (n, chain.id, chain._type, chain.natoms, len(chain)))
            n += 1
        ...
        if model == 1:
            order, merge = check_merge(chains, options['mergeList'], options['linkList'],
        ...
        if options["-x"].value:
            ...
            for i in order:
                ...
                if coarseGrained:
                    ...
                    logging.warning(
                        "No mapping for coarse graining chain %s (%s); chain is skipped." % (ci.id, ci.type()))
    ...
    if options['-o']:
        ...
        if options['CystineCheckBonds']:
            logging.info(
                "Checking for cystine bridges, based on sulphur (SG) atoms lying closer than %.4f nm" % math.sqrt(
                    options['CystineMaxDist2'] / 100))
        ...
        for mi in range(len(molecules)):
            ...
            if mol not in moleculeTypes or options['SeparateTop']:
                ...
                if options['ElasticNetwork']:
                    ...
                    top.bonds.extend(
                        [Bond(i, options=options, type=rubberType, category="Rubber band") for i in rubberList])
        ...
        for molecule in molecules:
            chainInfo = (
            n, moleculeTypes[molecule], len(molecule) > 1 and "s" or " ", " ".join([i.id for i in molecule]))
