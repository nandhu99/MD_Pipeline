...
#
# Script edited by Yoav Atsmon-Raz to incorporate 4 lipidated amino acids. 
#
...
class martini22:
    ...
    def __init__(self):
        ...
        self.bbtyp    = {                                                                   #                 #@#
                    ...
                    "GYM": spl("Nda   Nda   Nda   Nda   Nda   Nda   Nda   Nda   Nda")  # GYM bead defintions
        }                                                                                   #                 #@#
        ## BONDS ##                                                                         #                 
        ...
        self.sidechains = {
            ...
            "CYP": [spl("C5 C1 C1 C1 C1"), [(0.380,8000), (0.39,5000), (0.47,4500), (0.47,4500), (0.41,5500)],[(150,35),(125,25),(180,25),(180,28)]],
            "CYF": [spl("C5 C3 C3 C3 C3"), [(0.390,8000), (0.420,6000), (0.43,5000), (0.31,12000), (0.23,15000)],[(180,65),(125,42),(130,48),(170,50)]],
            "CYG": [spl("C5 C1 C1 C1 C1 C1"), [(0.380, 8500),  (0.420,6000), (0.420,7750), (0.41,7000), (0.40,9000), (0.24,8000)],[(150,50),(125,55),(130,45),(180,38),(180,75)]],              
            ...
            "ALA": [],
            "GLY": [],
            "GYM": [spl("C1 C1 C1 C1"),    [(0.36,7500),(0.47,3000),(0.47,4000),(0.36,5000)],                  [(140,30),(160,38),(175,45)]],
            }
...
#    bb_glym   = "N CA C O HN HA1 HA2"                                                                    #@#
    ...
    mapping = {
        "ALA":  nsplit(bb + " CB"),
        "CYS":  nsplit(bb, "CB SG"),
        "CYF":  nsplit(bb, "CB SG C1 C2", "C3 C4 C5 C6", "C7 C8 C9 C10","C11 C12 C13", "C13 C14 C15"),
        "CYP":  nsplit(bb, "CB SG C1 O", "C2 C3 C4 C5", "C6 C7 C8 C9", "C10 C11 C12 C13", "C14 C15 C16"),
        "CYG":  nsplit(bb, "CB SG C1 C2", "C2 C3 C5 C6", "C7 C8 C9 C10", "C11 C12 C13 C14", "C15 C16 C17", "C18 C19 C20"),
        "ASP":  nsplit(bb, "CB CG OD1 OD2"),
        "GLU":  nsplit(bb, "CB CG CD OE1 OE2"),
        "PHE":  nsplit(bb, "CB CG CD1 HD1", "CD2 HD2 CE2 HE2", "CE1 HE1 CZ HZ"),
        "GLY":  nsplit(bb),
        "GYM":  nsplit(bb, "C1 OL C2", "C3 C4 C5 C6", "C7 C8 C9 C10", "C11 C12 C13 C14"),
    ...
    residue_bead_names = spl("BB SC1 SC2 SC3 SC4 SC5 SC6 SC7")
